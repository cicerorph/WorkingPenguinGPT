...
(function(Scratch) {
  'use strict';
   ...
   // Initialize the api_url variable with a default value
	let api_url = 'https://corsproxy.io/?https://reverse.mubi.tech/v1/chat/completions';
        ...
        blocks: [
		{
		  ...
		  arguments: {
			URL: {
			  ...
			  defaultValue: 'https://corsproxy.io/?https://reverse.mubi.tech/v1/chat/completions'
			}
		  },
		},
		{
